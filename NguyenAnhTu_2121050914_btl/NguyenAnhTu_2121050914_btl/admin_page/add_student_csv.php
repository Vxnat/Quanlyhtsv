...
<body>
                    ...
                    <div class="mb-3">
                        <div class="content-wrapper">
                            ...
                            <div class="page-content">
                                ...
                                <form method="POST">
                                    <div id="load-data-student-csv">
                                        <table id="data-student-csv">
                                            <thead>
                                                <th>Số thứ tự</th>
                                                <th>Mã sinh viên</th>
                                                <th>Họ lót</th>
                            ...
                            <div class="control-table-csv">
                                ...
                                <button type="button" id="add_data_student_csv">Xác nhận</button>
                            </div>
    ...
    <script src="../js/add_student_csv.js"></script>
</body>
