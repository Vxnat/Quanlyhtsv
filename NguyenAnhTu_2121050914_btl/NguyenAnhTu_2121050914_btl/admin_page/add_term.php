                ...
                <div class="container-fluid">
                    <div class="mb-3">
                        <div class="content-wrapper">
                            <div class="page-title">Thêm học phần</div>
                            <div class="page-content">
                                <form method="POST">
                                    <div class="form-add-score-term">
                                        <div class="box">
                                            <h4>Mã học phần</h4>
                                            <input id="mhp" type="text">
                                        </div>
                                        <div class="box">
                                            <h4>Tên học phần</h4>
                                            <input id="thp" type="text">
                                        </div>
                                        <div class="box">
                                            <h4>Tín chỉ</h4>
                                            <input id="tinchi" type="text"><br>
                                        </div>
                                        <div class="box">
                                            <button type="button" id="submit_add_term">Xác nhận</button>
                                        </div>
                                    </div>
